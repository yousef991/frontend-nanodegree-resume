...
var work = {
  ...
  "display": function() {
    ...
    work.jobs.forEach(function(job) {
      var expstart = HTMLworkStart.replace("%data%", job.workstart);
      $("#workExperience").append(expstart);
      var expemploy = HTMLworkEmployer.replace("%data%", job.employ);
      $("#workExperience").append(expemploy);
      var expdate = HTMLworkDates.replace("%data%", job.date);
      $("#workExperience").append(expdate);
      var explocation = HTMLworkLocation.replace("%data%", job.location);
      $("#workExperience").append(explocation);
      var expdescrip = HTMLworkDescription.replace("%data%", job.descrip);
